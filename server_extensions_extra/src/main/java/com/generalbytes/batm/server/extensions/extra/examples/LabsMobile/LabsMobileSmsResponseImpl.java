...
public class LabsMobileSmsResponseImpl implements ISmsResponse {
    private final String sid;
    private final ResponseStatus status;
    private final BigDecimal price;
    private final ISmsErrorResponse errorResponse;

    public LabsMobileSmsResponseImpl(String sid, ResponseStatus status, BigDecimal price, ISmsErrorResponse errorResponse) {
        this.sid = sid;
        this.status = status;
        this.price = price;
